...
export class SuiviTransportService {
  private url = 'http://192.168.1.131:3000/transport/suivi';
  private urlFiltre = 'http://192.168.1.131:3000/transport/suiviFiltre';
  private urlexport = 'http://192.168.1.131:3000/transport/exportdata';
  ...
  async insertAssignQuartierAxe(
    ...
    const url = `http://192.168.1.131:3000/transport/insert-assign-quartier-axe/${id}`;
